...
function Footer() {
  ...
  //if (!isOpen) return <p>Closed</p>; // mundemmi me i ba 2 ose ma shume returna mbrenda nje komponente vete se per cdo return shtese duhet me pase ni condition(kusht) per qat return
